 ...
 /*
 int hour01s = 0;                    // Variables for the clock  
 int hour10s = 0;  
 int hours;  
 int minutes01s = 0;  
 int minutes10s = 0;  
 ...
 int seconds10s = 0;  
 int seconds;  
 int savedSeconds10s = seconds10s;  
 int savedMinutes01s = minutes01s;  
 String minutesValText;              // contains minutes text  
 String hoursValText;                // contains hour text  
 String voornaText;                  // can be 'voor' , 'na' or empty. 'voor' means 'before' , 'na' means 'after'  
 String halfText;                    // can be 'half' or empty.        'half' surprisingly means 'half'   
 String hourText;                    // can be 'uur' or empty.         'uur' means 'hour'  
 int hourPos;                        // used for position of hour text  
 int voornaPos;                      // used for position of 'voor' or 'na' text  
 int halfPos;                        // used for position of 'half' text  
 int hourTextPos;                    // used for position of 'uur' text  
 int hourLength;                     // keeps lenght of hour text  
 */
 int an, an01, an10;
